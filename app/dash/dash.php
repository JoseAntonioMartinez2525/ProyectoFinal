...
<!--nav-->
	...
	<h1 class="title_grafico">Visualizaciones por categoria </h1>
	<div class="container">
  <!-- DONUT CHART BLOCK (LEFT-CONTAINER) --> 
  <div class="donut-chart-block block"> 
                    <h2 class="titular"> AUDIENCE STATS</h2>
 ...
 <!-- FIN AÑADIDO GRÄFICO -->
                            <p class="center-date">September<br><span class="scnd-font-color">2020</span></p>        
                    </div>
                    <ul class="os-percentages horizontal-list">
                        <li>
                            <p class="ios os scnd-font-color">animation</p>
                            <p class="os-percentage">21<sup>%</sup></p>
                        </li>
                        <li>
                            <p class="mac os scnd-font-color">drama</p>
                            <p class="os-percentage">39<sup>%</sup></p>
                        </li>
                        <li>
                            <p class="linux os scnd-font-color">accion</p>
                            <p class="os-percentage">9<sup>%</sup></p>
                        </li>
                        <li>
                            <p class="win os scnd-font-color">comedy</p>
               ...
               <span data-valor='5'>   
                 ...
                 <span data-valor='12'>
                    ...
                    <ul class="month-data clear">
                        <li>
                            <p>June<span class="scnd-font-color"> 2020</span></p>
                            <p><span class="entypo-plus increment"> </span>21<sup>%</sup></p>
                        </li>
                        <li>
                            <p>July<span class="scnd-font-color"> 2020</span></p>
                            <p><span class="entypo-plus increment"> </span>48<sup>%</sup></p>
                        </li>
                        <li>
                            <p>AGO<span class="scnd-font-color"> 2020</span></p>
